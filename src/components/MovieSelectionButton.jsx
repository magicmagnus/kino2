...
const MovieSelectionButton = (props) => {
    ...
    return (
        <button
            onClick={onClick}
            className={
                "flex h-10 w-44 min-w-44 rounded-lg text-xs font-semibold transition-all duration-200 hover:bg-rose-500 hover:text-rose-50" +
                (selected
        ...
        >
            ...
            <div className="flex flex-col items-start justify-center gap-1.5 overflow-hidden px-3 text-left">
