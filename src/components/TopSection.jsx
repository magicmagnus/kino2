        ...
        <>
            ...
            <div className="sticky top-0 z-20 bg-zinc-800 ">
                ...
                <div className="flex bg-zinc-900  ">
                    ...
                    <div className='flex justify-center items-center text-center sticky left-0 w-8 flex-shrink-0  bg-zinc-900  z-20' />
                    {HOURS.map((hour) => (
                        <div key={hour}
                            className="flex-shrink-0 w-28 px-3 py-1 text-left ">
                            <p className='text-sm text-white w-fit'>{hour}</p>
                        </div>
                    ))}
                </div>
